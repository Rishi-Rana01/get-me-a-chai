        ...
        <div className='container mx-auto py-5 px-6 '>
            ...
            <form className="max-w-2xl mx-auto" >
                ...
                <div className="my-2">
                    ...
                    <input value={form.coverpic ? form.coverpic : ""} onChange={handleChange} type="file" name='coverpic' id="coverpic" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                </div>
                {/* input razorpay id */}
                <div className="my-2">
