            ...
            <div className="flex flex-col gap-6 items-center p-10">
                ...
                <div className="w-full max-w-md bg-gray-800 rounded-lg shadow-md p-6 mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-2 px-4 bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl text-white font-medium rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                        >
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    <button onClick={() => { signIn("github") }}
                        className="flex items-center bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
